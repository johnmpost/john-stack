 ...
 * @category constructors
 */
export const timer = (ms, shouldYield = defaultShouldYield) => make(task => timeout.set(task, ms), shouldYield);
/**
 * @since 2.0.0
 * @category constructors
 */
export const timerBatched = (ms, shouldYield = defaultShouldYield) => makeBatched(task => timeout.set(task, ms), shouldYield);
/** @internal */
