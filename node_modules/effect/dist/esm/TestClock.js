 ...
 * @since 2.0.0
 */
export const TestClock = /*#__PURE__*/Context.Tag( /*#__PURE__*/Symbol.for("effect/TestClock"));
/**
...
export class TestClockImpl {
  ...
  sleep(durationInput) {
    ...
    return core.flatMap(core.deferredMake(), deferred => pipe(ref.modify(this.clockState, data => {
      ...
      return [false, data];
    }), core.flatMap(shouldAwait => shouldAwait ? pipe(this.warningStart(), core.zipRight(core.deferredAwait(deferred))) : pipe(core.deferredSucceed(deferred, void 0), core.asUnit))));
  }
  /**
