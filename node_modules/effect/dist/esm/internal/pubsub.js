...
class UnboundedPubSub {
  publisherHead = new Node(AbsentValue, 0, null);
  publisherIndex = 0;
  publisherTail;
  subscribersIndex = 0;
...
class BackPressureStrategy {
  ...
  get shutdown() {
    return core.flatMap(core.fiberId, fiberId => core.flatMap(core.sync(() => unsafePollAllQueue(this.publishers)), publishers => fiberRuntime.forEachConcurrentDiscard(publishers, ([_, deferred, last]) => last ? pipe(core.deferredInterruptWith(deferred, fiberId), core.asUnit) : core.unit, false, false)));
  }
