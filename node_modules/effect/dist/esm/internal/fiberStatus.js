...
class Done {
  ...
  _tag = OP_DONE;
  [Hash.symbol]() {
    return pipe(Hash.hash(FiberStatusSymbolKey), Hash.combine(Hash.hash(this._tag)));
  }
  [Equal.symbol](that) {
...
class Running {
  ...
  [Hash.symbol]() {
    return pipe(Hash.hash(FiberStatusSymbolKey), Hash.combine(Hash.hash(this._tag)), Hash.combine(Hash.hash(this.runtimeFlags)));
  }
  [Equal.symbol](that) {
...
class Suspended {
  ...
  [Hash.symbol]() {
    return pipe(Hash.hash(FiberStatusSymbolKey), Hash.combine(Hash.hash(this._tag)), Hash.combine(Hash.hash(this.runtimeFlags)), Hash.combine(Hash.hash(this.blockingOn)));
  }
  [Equal.symbol](that) {
