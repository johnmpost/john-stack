...
/* @internal */
export const labelMetrics = /*#__PURE__*/dual(2, (self, labels) => core.fiberRefLocallyWith(self, core.currentMetricLabels, old => ReadonlyArray.union(old, labels)));
/* @internal */
...
/** @internal */
export const makeSpan = (name, options) => core.flatMap(fiberRefs, fiberRefs => core.sync(() => {
  ...
  const links = linksFromEnv._tag === "Some" ? [...Chunk.toReadonlyArray(linksFromEnv.value), ...(options?.links ?? [])] : options?.links ?? [];
