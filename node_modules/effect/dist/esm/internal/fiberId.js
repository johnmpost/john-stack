...
class None {
  ...
  _tag = OP_NONE;
  [Hash.symbol]() {
    return pipe(Hash.hash(FiberIdSymbolKey), Hash.combine(Hash.hash(this._tag)));
  }
  [Equal.symbol](that) {
...
class Runtime {
  ...
  [Hash.symbol]() {
    return pipe(Hash.hash(FiberIdSymbolKey), Hash.combine(Hash.hash(this._tag)), Hash.combine(Hash.hash(this.id)), Hash.combine(Hash.hash(this.startTimeMillis)));
  }
  [Equal.symbol](that) {
...
class Composite {
  ...
  [Hash.symbol]() {
    return pipe(Hash.hash(FiberIdSymbolKey), Hash.combine(Hash.hash(this._tag)), Hash.combine(Hash.hash(this.left)), Hash.combine(Hash.hash(this.right)));
  }
  [Equal.symbol](that) {
