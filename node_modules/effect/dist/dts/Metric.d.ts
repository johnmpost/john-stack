 ...
 * @category aspects
 */
export declare const increment: (self: Metric.Counter<number> | Metric.Counter<bigint>) => Effect.Effect<never, never, void>;
/**
 * @since 2.0.0
 * @category aspects
 */
 ...
 * @category getters
 */
export declare const snapshot: Effect.Effect<never, never, ReadonlyArray<MetricPair.MetricPair.Untyped>>;
/**
