...
export declare namespace Case {
     ...
     * @category models
     */
    interface Constructor<A extends Case, Tag extends keyof A = never> {
 ...
 * @since 2.0.0
 */
export declare const struct: <A extends Record<string, any>>(a: A) => Data<{
    readonly [P in keyof A]: A[P];
}>;
/**
 * @category constructors
 ...
 * @category constructors
 */
export declare const Class: new <A extends Record<string, any> = {}>(args: Types.Equals<Omit<A, keyof Equal.Equal>, {}> extends true ? void : {
 ...
 * @category constructors
 */
export declare const TaggedClass: <Tag extends string>(tag: Tag) => new <A extends Record<string, any> = {}>(args: Types.Equals<Omit<A, keyof Equal.Equal>, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" | keyof Equal.Equal ? never : P]: A[P]; }) => Data<Readonly<A> & {
    readonly _tag: Tag;
}>;
/**
 * @since 2.0.0
 * @category constructors
 */
export declare const Structural: new <A>(args: Types.Equals<Omit<A, keyof Equal.Equal>, {}> extends true ? void : {
    readonly [P in keyof A as P extends keyof Equal.Equal ? never : P]: A[P];
}) => Case;
/**
 ...
 * @category models
 */
export type TaggedEnum<A extends Record<string, Record<string, any>> & UntaggedChildren<A>> = keyof A extends infer Tag ? Tag extends keyof A ? Data<Types.Simplify<{
    readonly _tag: Tag;
} & {
...
export declare namespace TaggedEnum {
    ...
    type Args<A extends {
        readonly _tag: string;
    } & Equal.Equal, K extends A["_tag"], E = Extract<A, {
        readonly _tag: K;
    }>> = {
        readonly [K in keyof E as K extends "_tag" | keyof Case ? never : K]: E[K];
    ...
    type Value<A extends {
        readonly _tag: string;
    } & Equal.Equal, K extends A["_tag"]> = Extract<A, {
        readonly _tag: K;
    }>;
}
/**
 ...
 * @category constructors
 */
export declare const Error: new <A extends Record<string, any> = {}>(args: Types.Equals<Omit<A, keyof Equal.Equal>, {}> extends true ? void : {
    readonly [P in keyof A as P extends keyof Equal.Equal ? never : P]: A[P];
 ...
 * @category constructors
 */
export declare const TaggedError: <Tag extends string>(tag: Tag) => new <A extends Record<string, any> = {}>(args: Types.Equals<Omit<A, keyof Equal.Equal>, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" | keyof Equal.Equal ? never : P]: A[P]; }) => Cause.YieldableError & {
    readonly _tag: Tag;
} & Readonly<A>;
