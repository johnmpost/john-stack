...
const cached = exports.cached = /*#__PURE__*/(0, _Function.dual)(2, (self, timeToLive) => core.map(cachedInvalidate(self, timeToLive), tuple => tuple[0]));
/** @internal */
const cachedInvalidate = exports.cachedInvalidate = /*#__PURE__*/(0, _Function.dual)(2, (self, timeToLive) => {
