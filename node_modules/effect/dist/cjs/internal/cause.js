...
const proto = {
  ...
  [Hash.symbol]() {
    return (0, _Function.pipe)(Hash.hash(CauseSymbolKey), Hash.combine(Hash.hash(flattenCause(this))));
  },
  [Equal.symbol](that) {
...
const prettyErrorMessage = u => {
  ...
  // 2)
  if ((0, _Predicate.hasProperty)(u, "toString") && (0, _Predicate.isFunction)(u["toString"]) && u["toString"] !== Object.prototype.toString) {
    return u["toString"]();
  }
  // 3)
