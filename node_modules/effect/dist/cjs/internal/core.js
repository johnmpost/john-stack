...
/* @internal */
const matchCauseEffect = exports.matchCauseEffect = /*#__PURE__*/(0, _Function.dual)(2, (self, {
  onFailure,
  onSuccess
}) => {
  ...
  effect.i1 = onFailure;
  effect.i2 = onSuccess;
  (0, _internalize.internalize)(onFailure);
  (0, _internalize.internalize)(onSuccess);
  return effect;
});
/* @internal */
...
/* @internal */
const onError = exports.onError = /*#__PURE__*/(0, _Function.dual)(2, (self, cleanup) => onExit(self, unified(exit => exitIsSuccess(exit) ? unit : cleanup(exit.i0))));
/* @internal */
...
const whenEffect = exports.whenEffect = /*#__PURE__*/(0, _Function.dual)(2, (self, predicate) => flatMap(predicate, b => {
  if (b) {
...
/* @internal */
const never = exports.never = /*#__PURE__*/asyncEither(() => {
