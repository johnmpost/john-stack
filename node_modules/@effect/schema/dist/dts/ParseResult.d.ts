 ...
 * @since 1.0.0
 */
export declare const fail: (error: ParseError | ParseIssue | ReadonlyArray.NonEmptyReadonlyArray<ParseIssue>) => ParseResult<never>;
/**
 ...
 * @since 1.0.0
 */
export declare const bimap: <A, B>(self: ParseResult<A>, f: (error: ParseError) => ParseError, g: (a: A) => B) => ParseResult<B>;
/**
 * @category optimisation
 * @since 1.0.0
 */
